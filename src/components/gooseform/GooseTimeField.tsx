...
export default function GooseTimeField(inp: any) {
    ...
    return (<>
        <input type={"time"} onChange={aggiornaStato} className='form-control' id={id} name={config.name} disabled={config.disabled} readOnly={config.readonly} value={formData[id]} />
    </>);
