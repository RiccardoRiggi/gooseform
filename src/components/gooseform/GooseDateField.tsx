...
export default function GooseDateField(inp: any) {
    ...
    return (<>
        <input type={"date"} onChange={aggiornaStato} className='form-control' id={id} name={config.name} disabled={config.disabled} readOnly={config.readonly} value={formData[id]} />
    </>);
